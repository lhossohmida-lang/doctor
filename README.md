...
`queueCounters` هو عداد عام محدود لا يحتوي بيانات طبية أو مالية، ويستخدم لمنع تكرار أرقام الدور بين تسجيل الإدارة وتسجيل الزبون. عند تسجيل الزبون من الواجهة العامة يتم تحديث `dailyCounters` أيضًا حتى يظهر نفس رقم الزبون داخل لوحة الطبيب. `publicTickets` لا يحتوي المرض أو المبلغ أو حالة الدفع. `publicLookups` يسمح بالبحث برقم الهاتف دون السماح باستعراض قائمة الزبائن.
